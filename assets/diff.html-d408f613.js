import{_ as v,M as c,p as w,q as g,R as s,Q as r,Z as x,ac as S,t as N,N as m,V as C,a1 as D}from"./framework-c9763b50.js";import{f as V}from"./sqlFormatter-922d1afc.js";import"./mermaid-c798b724-95c3f3a8.js";const p="diff1",u="diff2",h="diffm";function l(t){try{if(window)return localStorage.getItem(t)}catch{}}function f(t,e){try{window&&localStorage.setItem(t,e)}catch{}}const O={data(){let t=l(p),e=l(u),o=l(h);return[void 0,null].includes(t)&&(t=`Hello world.
      Diff inline
